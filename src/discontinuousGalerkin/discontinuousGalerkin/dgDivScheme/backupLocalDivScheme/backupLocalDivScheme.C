...
//                else if (fluxDirOwn > 0.0)
                ...
                {
                      ls[faceI](coeffJ, coeffI) += 0.5*diagCoeffNei[mtxCoeff];
                      ds[own](coeffJ, coeffI) += 0.5*diagCoeffOwn[mtxCoeff];
                }
                else
                {
                      us[faceI](coeffJ, coeffI) += 0.5*diagCoeffOwn[mtxCoeff];
                      ds[nei](coeffJ, coeffI) += 0.5*diagCoeffNei[mtxCoeff];
                }
